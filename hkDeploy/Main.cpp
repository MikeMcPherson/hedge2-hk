...
#include <hkDeploy/Top/hkDeployTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    hkDeploy::setupTopology(inputs);
    hkDeploy::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    hkDeploy::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
