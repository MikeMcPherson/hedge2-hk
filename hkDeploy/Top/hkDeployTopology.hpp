// ======================================================================
// \title  hkDeployTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef HKDEPLOY_HKDEPLOYTOPOLOGY_HPP
#define HKDEPLOY_HKDEPLOYTOPOLOGY_HPP
// Included for access to hkDeploy::TopologyState and hkDeploy::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <hkDeploy/Top/hkDeployTopologyDefs.hpp>

// Remove unnecessary hkDeploy:: qualifications
 ...
 * hkDeploy::TopologyState see: hkDeployTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type hkDeploy::TopologyState see: hkDeployTopologyDefs.hpp.
 *
